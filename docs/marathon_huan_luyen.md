...
Sau khi chạy ablation kỹ lưỡng, SmolLM3 sẵn sàng cho lần chạy toàn diện. Các ablation 3B trên 100B token trông đầy hứa hẹn. MFU (Model FLOPs Utilization) được tối ưu khoảng **30%** trên 384 GPU.
...
:::important Bài học
"Giá trị thực sự của setup ablation vững chắc vượt xa việc xây mô hình tốt. Khi sai sót xảy ra trong lần huấn luyện chính, ta muốn tự tin vào mọi quyết định đã đưa ra và nhanh chóng xác định thành phần nào chưa được kiểm tra kỹ."
:::
