...
Lĩnh vực machine learning (học máy) có một mối quan hệ ám ảnh với tối ưu hóa. Chúng ta bị cuốn vào loss curve (đường cong mất mát), kiến trúc mô hình, và throughput (thông lượng); xét cho cùng, machine learning về cơ bản là tối ưu hóa hàm loss của một mô hình. Tuy nhiên, trước khi lao vào các chi tiết kỹ thuật, có một câu hỏi cơ bản hơn thường không được đặt ra: **Liệu chúng ta có nên huấn luyện mô hình này không?**
...
Lưu đồ sau hướng dẫn quá trình tư duy mà bạn nên đi qua trước khi bắt đầu một dự án pretraining lớn:
